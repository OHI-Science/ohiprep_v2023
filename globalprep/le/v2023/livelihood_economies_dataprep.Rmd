...
release, an updated version of the data should be downloaded and used.

-   FAO Capture Production Quantity

    -   The [FAO capture
        production](https://www.fao.org/fishery/en/collection/capture?lang=en)
        data was downloaded via the Statistical Query Panel. This data is
...
-   FAO Aquaculture Production
    ...
    -   Data from the [Global Aquaculture Production](https://www.fao.org/fishery/en/collection/aquaculture?lang=en) dataset:
...
**From the OHI methods:** We used the [Occupational Wages around the
