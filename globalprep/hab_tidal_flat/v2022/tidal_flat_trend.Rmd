...
try filtering out small areas 

try cutting highly variable

try increasing time steps
...
tidal_flat_trend_2013 <- tidal_flat_extent %>%
  ...
  dplyr::mutate(trend = (estimate / km2) * 5, year = 2013) %>% 
  tidyr::replace_na(list(trend = 0)) %>% 
