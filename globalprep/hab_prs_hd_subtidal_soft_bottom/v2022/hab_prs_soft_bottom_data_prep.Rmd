...
**Description**: Number of square kilometers of soft bottom habitat that is associated with each of the 220 OHI regions. 
...
3. Layer the fishing effort data with OHI regional polygons for land and EEZ to extract only fishing effort within regions of interest
4. Standardize by soft-bottom habitat of each region calculate fishing effort for each OHI region
