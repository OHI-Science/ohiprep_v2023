...
write.csv(myMergedData, file.path(here(), save_loc_data, "STEP6_prep_layers/output/cw_fertilizers_score_updated.csv"), row.names=FALSE)
...
write.csv(data, file.path(here(), "globalprep/prs_land-based_nutrient/v2021/STEP6_prep_layers/output/cw_fertilizers_trend_updated.csv"),
          row.names=FALSE)
```
