...
```{r}
save_loc_rasts <- file.path(dir_M, "git-annex/globalprep/prs_land-based_nutrient/v2021/output/final_layers")
...
write.csv(myMergedData, file.path(save_loc_data, "STEP6_prep_layers/output/cw_fertilizers_score_updated.csv"), row.names=FALSE)
...
write.csv(myMergedData, file.path(here(), save_loc_data, "STEP6_prep_layers/output/cw_fertilizers_score_3nm_updated.csv"), row.names=FALSE)
...
for (year in 2009:2019){ # year = 2012
  trend <- read.csv(sprintf("globalprep/prs_land-based_nutrient/v2021/STEP6_prep_layers/int/cw_fertilizers_trend_%s_new.csv", year))
...
write.csv(data, "globalprep/prs_land-based_nutrient/v2021/STEP6_prep_layers/output/cw_fertilizers_trend_updated.csv",
          row.names=FALSE)
```
...
```{r}
  old <- read.csv('globalprep/prs_land-based_nutrient/v2016/output/cw_fertilizers_trend_2016_new.csv') %>%
...
abline(0, 1, col="red")
  ...
  old <- read.csv('globalprep/prs_land-based_nutrient/v2016/output/cw_fertilizers_score_3nm_updated.csv') %>%
    filter(year == 2016) %>%
