...
Multiply our leaching and volatized rasters by the appropriate surfwater rasters to get an estimate of the amount of N that will reach the coast. See below for more instructions. 
...
3. Join the surface water nutrient layer sums with the total nutrient sums, and compare the percentages of each.
