...
For each stock: 
- Missing years are gapfilled using a linear regression model that includes data from 2001 to 2018 (2018 is the final year of SAUP data). To be included in the gapfilling, there have to be 5 or more years of B/Bmsy data occuring over the last 11 years of data, from 2005 to 2015.
...
Summary: 
- There are 432 RAM stocks with at least 5 years of B/Bmsy data from 2005 to 2015. 
- 289 of these stocks have at least 1 year of gapfilled data.  
...
tmp <- data.frame(scientificname = sort(setdiff(ram_sp$scientificname, SAUP_sp$SAUP_scientificname))) # 47 species names

# compare names - what's in SAUP that's not in RAM
tmp2 <- data.frame(scientificname = sort(setdiff(SAUP_sp$SAUP_scientificname, ram_sp$scientificname))) # 2070 species names.. unfortunately a lot.
