...
- New year of FAO data (1976-2020)
- Add/edit code for the Datacheck section
- Add a tic/toc
- Add more programmatic year usage
...
**Reference**:
    ...
    App release date: March 2023
FAO raw commodities quantity 1976_2020
FAO raw commodities value 1976_2020
FAO metadata found [here](http://www.fao.org/fishery/statistics/global-commodities-production/en)

**Downloaded**: June 29, 2023
...
common_year <- as.character(as.numeric(scen_year) - 4) # this depends on what the latest data year is; currently, there's a 3 year lag so the common year between the current and previous version year would be 4 years prior to the current version year
...
# v2023: region 9 and 139 have NAs (for every row) which is a change from the previous version year
