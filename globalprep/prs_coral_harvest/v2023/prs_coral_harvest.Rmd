...
- Add a tic/toc for timing purposes
...
# 
#                 Eswatini 
#                        1 (landlocked/not used)
# Micronesia (Fed. States) 
#                        1 (added in above - Micronesia)
# Netherlands (Kingdom of the) 
#                        1 (added in above - Netherlands)                           
#          North Macedonia 
#                        1 (landlocked/not used)
#                Palestine 
#                        1 (not used)
# Saint Helena/Asc./Trist. 
#                        1 (added in above - Saint Helena)
#                  Türkiye 
#                        1 (added in above - Turkey)
# Venezuela (Boliv Rep of) 
#                        1 (added in above - Venezuela)
#           Yugoslavia SFR 
