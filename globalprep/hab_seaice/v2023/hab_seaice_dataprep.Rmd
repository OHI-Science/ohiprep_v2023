...
2.  To download the raw data, you must go to this website:
    ...
    "NSIDC0051_SEAICE_PS\_?25km_YYYYMM_v2.0.nc", with ? representing N
...
This is because all monthly files follow the format
"NSIDC0051_SEAICE_PS\_?25km_YYYYMM_v2.0.nc", with ? representing N or S
for North or South. Click "Order Files" and wait until your order is
