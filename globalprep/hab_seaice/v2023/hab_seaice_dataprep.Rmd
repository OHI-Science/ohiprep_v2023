...
health_old_new <-  dplyr::left_join(health_2022, health_2021)
...
trend_old_new <- dplyr::left_join(trend_2022, trend_2021)

year_trend_change_plot <-ggplot() + geom_point(data = trend_old_new, aes(x = trend_prev_assess, y = trend, text = rgn_id)) + labs(x = "previous year trend", y = "current trend") + geom_abline(slope = 1, intercept = 0, col = "red")
