...
2.  To download the raw data, you must go to this website:
    ...
    "NSIDC0051_SEAICE_PS_N25km_20220630_v2.0.ncc", with H hemisphere (N
    or S).

3.  

4.  Click the download script option just below the search results. It
...
5.  Place this file (eg. `nsidc-download_NSIDC-0051.001_2022-06-06.py`)
    in the folder
    `/home/shares/ohi/git-annex/globalprep/_raw_data/NSIDC_SeaIce/<version_year>`

6.  Create "xml", "north" and "south" folders in the same directory
    above
...
-   `mv **/*PS_N*.nc /home/shares/ohi/git-annex/globalprep/_raw_data/NSIDC_SeaIce/v2023/north`
...
This is because all monthly files follow the formatThis is because all
monthly files follow the format
"NSIDC0051_SEAICE_PS_N25km_20220630_v2.0.ncc", with H hemisphere (N or
S). Click "Order Files" and wait until your order is processed. Once
processed (should only take a couple of minutes, you will receive an
email with instructions), download the zip file and place it into the
git-annex/globalprep/\_raw_data/NSIDC_SeaIce/vyear folder on Mazu and
extract it.
...
data: - Enter
`cd /home/shares/ohi/git-annex/globalprep/_raw_data/NSIDC_SeaIce/v2021/5000001093042`
to do this.

Now move all of the xml files to the xml folder that your have
created: -
...
`mv **/*PS_N*.nc /home/shares/ohi/git-annex/globalprep/_raw_data/NSIDC_SeaIce/v2023/north` -
`mv **/*PS_S*.nc /home/shares/ohi/git-annex/globalprep/_raw_data/NSIDC_SeaIce/v2023/south`

NOTE: remember to change the assessment year to whatever assessment you
are conducting.

`/home/shares/ohi/git-annex/globalprep/_raw_data/NSIDC_SeaIce/v2023_a/north`
