...
n_edge <- read.csv(here("globalprep/hab_seaice/v2023/int/n_IceEdgeHabitat_ref1979to2000.csv"))
s_edge <- read.csv(here("globalprep/hab_seaice/v2023/int/s_IceEdgeHabitat_ref1979to2000.csv"))
...
n_shore <- read.csv(here("globalprep/hab_seaice/v2023/int/n_IceShoreProtection_ref1979to2000.csv"))
s_shore <- read.csv(here("globalprep/hab_seaice/v2023/int/s_IceShoreProtection_ref1979to2000.csv"))
...
write.csv(data, here("globalprep/hab_seaice/v2023/int/sea_ice.csv"), row.names = FALSE)
...
write.csv(health, here("globalprep/hab_seaice/v2023/output/hab_ice_health_eez.csv"), row.names = FALSE) # save sea ice health data
...
write.csv(trend, here("globalprep/hab_seaice/v2023/output/hab_ice_trend_eez.csv"), row.names = FALSE) # save sea ice trend data
...
write.csv(extent, here("globalprep/hab_seaice/v2023/output/hab_ice_extent_eez.csv"), row.names = FALSE) # save sea ice extent data
...
## Health comparison
health <- read.csv(here("globalprep/hab_seaice/v2023/output/hab_ice_health_eez.csv"))
ice_health_eez <- read.csv(here(file.path("globalprep/hab_seaice/",previous_year,"output/hab_ice_health_eez.csv"))) %>% # compare to last year's data
...
## Trend comparison
trend <- read.csv(here(file.path(assess_year,"output/hab_ice_trend_eez.csv")))
ice_trend_eez <- read.csv(file.path("globalprep/hab_seaice/",previous_year,"output/hab_ice_trend_eez.csv")) %>% # compare to last year's data
