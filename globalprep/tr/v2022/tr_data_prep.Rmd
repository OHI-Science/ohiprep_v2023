...
[REFERENCE RMD FILE](http://ohi-science.org/ohiprep_v2022/globalprep/tr/v2021/tr_data_prep.html)
...
source(here("globalprep/tr/v", version_year, "/R/tr_fxns.R"))

setwd(here("globalprep/tr/v", version_year))
...
These data are from the World Economic Forum's "Travel and Tourism Competitiveness Report" (https://www.weforum.org/reports/travel-and-tourism-development-index-2021/downloads-510eb47e12) See mazu: _raw_data/WEF-Economics/ for more details and the raw data.
...
ttdi_raw <- read_excel(here(paste0("globalprep/tr/v", version_year, "/raw/", ttdi_file)),
                 skip = 2) 
...
weight_data <- data.frame(country = c("China", "Hong Kong SAR"),
                          # pop values from World Bank 2021 estimates
