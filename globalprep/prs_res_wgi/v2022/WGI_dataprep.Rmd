...
June 29, 2022 (source data updated Sep 2021)

**Description**:  
The Worldwide Governance Indicators (WGI) project reports aggregate and individual governance indicators for 215 economies over the period 1996–2020, for six dimensions of governance:
...
d <- read.csv(here(paste0('globalprep/prs_res_wgi/v', scen_year, '/raw/worldbank_wgi_from_wdi_api_2022-06-29.csv'))) # change appended date to most recent version
...
worldbank_wgi_from_wdi_api <- read_csv(paste0("globalprep/prs_res_wgi/v", scen_year, "/raw/worldbank_wgi_from_wdi_api_2022-06-29.csv"))
