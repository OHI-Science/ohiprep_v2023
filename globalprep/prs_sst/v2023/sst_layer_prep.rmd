...
# Specify years for calculations, the data set's years
yrs <- 1982:2022
...
plot(rast(sst_rasters[[length(sst_rasters)]])) 
...
# 2021 vs 2023 pressure scores dot plot
p <- ggplot(data = compare) +
  geom_point(aes(x = v2021, y = v2023)) +
...
hist2021 <- ggplot(compare, aes(x = v2021)) +
  geom_histogram(fill = "gray", color = "black") + 
  theme_bw() + 
  labs(title = "SST 2021")

hist2023 <- ggplot(compare, aes(x = v2023)) +
  geom_histogram(fill = "gray", color = "black") + 
  theme_bw() + 
  labs(title = "SST 2023")
...
# compare sd between new and old methods
