...
Previously, data source only extended from 1982 to 2012. In the 2016 assessment, the data year 2012 was used as a proxy for 2016, data year 2011 was used as a proxy for 2015, and so on. For the 2021 assessment, data year will match 2020, so data year 2020 represents year 2019, and so on. 
...
for(i in 5:53){
 ...
 ## try with parallel processing 10 cores.. this will speed it up significantly. 
