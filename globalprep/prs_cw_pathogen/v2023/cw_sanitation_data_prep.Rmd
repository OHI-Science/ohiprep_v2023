...
```{r}
url <- "https://sdmx.data.unicef.org/ws/public/sdmxapi/rest/data/UNICEF,WASH_HOUSEHOLDS,1.0/.WS_PPL_S-ALB.SAN.._T?format=sdmx-generic-2.0"

dataset <- readSDMX(url) %>% as_tibble()
```
