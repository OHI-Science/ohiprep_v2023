...
## 0  of these out of 36611  cases had NA values converted to 0 - 2021 assessment
...
sw_sus_rgn$species <- gsub("Blood clams", "Blood cockle", sw_sus_rgn$species)
sw_sus_rgn$species <- gsub("Cockle", "Cockles nei", sw_sus_rgn$species)
sw_sus_rgn$species <- gsub("Chinook salmon", "Chinook(=Spring=King) salmon", sw_sus_rgn$species)
sw_sus_rgn$species <- gsub("Littleneck clam", "Pacific littleneck clam", sw_sus_rgn$species)
sw_sus_rgn$species <- str_replace(sw_sus_rgn$species, "Hard clam \\(unspecified\\)", "Northern quahog(=Hard clam)") #  Hard clams are also known as quahogs, round clams, or hard-shell clams
sw_sus_rgn$species <- str_replace(sw_sus_rgn$species, "Lyrate hard clam", "Northern quahog(=Hard clam)") 
...
sw_sus_rgn$species <- str_replace(sw_sus_rgn$species, "Seaweed \\(unspecified\\)", "Seaweeds nei") 
...
summary(mar_sw_sus)
# Sust_avg still has 18551 NAs out of 30938 total obs.; ~60% without sustainability data
# esc_score still have 18551 NAs out of 30938 total obs; ~60% without scores
