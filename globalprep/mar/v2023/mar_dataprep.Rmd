...
-   New year of FAO mariculture yield data for 2021. Downloaded the data online instead of using the fishstatj software. Updated instructions for downlaoding the data. Updated the script to work with minor changes in formatting in the new data.
