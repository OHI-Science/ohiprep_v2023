...
Instructions on downloading the aquaculture data: Navigate to this link: https://www.fao.org/fishery/statistics-query/en/home. Click browse on Global aquaculture production. Click browse on Global aquaculture production Quantity (1950 - last data year). Scroll to the bottom of the dimensions section, and de-select all of the pre-selected years. Under the query definition section, drag Country Name En (if not already present), ASFIS species Name En, FAO major fishing area Name En, and Environment Name En, into the selected rows column from the possible fields column. Click on show data and confirm that data is present for 1950- two years prior to current date. Click download and select yes to include Null Values. Upload the file to the FAO_mariculture folder on MAZU. 
