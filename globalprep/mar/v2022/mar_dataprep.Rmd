...
## Compare yield data for all countries: 2020 versus 2019
...
## Compare yield data for all countries: 2019 last year to 2019 this year
mar_old <- read.csv("../v2021/output/MAR_FP_data.csv") %>% 
  filter(year == 2019) %>% 
  select(rgn_id, species, fao, old_value = value)
mar_new <- read.csv("output/MAR_FP_data.csv") %>% 
