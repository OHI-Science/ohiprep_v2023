...
sw_sus_rgn$species <- gsub("", "", sw_sus_rgn$species)

# sw_sus_rgn$species <- str_replace(sw_sus_rgn$species, "Seaweed", "Seaweeds nei") 
# sw_sus_rgn$species <- str_replace(sw_sus_rgn$species, "Black seabass", "Seabasses nei")
# sw_sus_rgn$species <- str_replace(sw_sus_rgn$species, "Striped seabass", "Seabasses nei")
# sw_sus_rgn$species <- str_replace(sw_sus_rgn$species, "Striped bass, hybrid", "Seabasses nei")
...
# check which countries have duplciates
