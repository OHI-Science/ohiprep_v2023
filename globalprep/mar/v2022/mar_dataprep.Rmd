...
# oldest <- read.csv(file.path(dir_M, 'git-annex/globalprep/_raw_data/seafood_watch_mar_sustainability/d2021/Seafood-Watch_aquaculture-recs_May-2021.csv'), check.names = FALSE, stringsAsFactors = FALSE, na.strings = c("NA", ""))
...
# juliet's notes to delete:
# cur_cols <- sort(colnames(sw_sus))
# cur_cols # 57
# old_cols <- sort(colnames(oldest))
# old_cols # 55
# intersect(cur_cols, old_cols) 
# setdiff(cur_cols, old_cols) #
# setdiff(old_cols, cur_cols)
# 
# head(sw_sus$AssessmentColor, 10)
# head(oldest$'Overall Recommendation', 10)
