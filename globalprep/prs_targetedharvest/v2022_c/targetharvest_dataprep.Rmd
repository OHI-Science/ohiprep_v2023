...
write_csv(
  target_harvest, 
  here('globalprep', 'prs_targetedharvest', paste0('v', version_year, '_c'), 'output', 'fao_targeted.csv')
)
...
write_csv(
  target_harvest_gf,
  here('globalprep', 'prs_targetedharvest', paste0('v', version_year, '_c'), 'output', 'fao_targeted_gf.csv')
)
```
