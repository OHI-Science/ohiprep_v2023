...
region_tidy_df <- region_df %>%
  ...
  dplyr::do(tidyr::fill(., score, .direction = "down")) %>%
  dplyr::ungroup() %>%
  dplyr::mutate(geo_area_name = ifelse(geo_area_name == "South-Eastern Asia", "South-eastern Asia", geo_area_name)) ## correct a typo
