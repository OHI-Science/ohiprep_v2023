...
#Bonaire, Saint Eustatius and Saba (fixed above)
#Channel Islands (fixed above)
## Eswatini (not OHI),
...
## deal with the duplicates - v2022 this brought from 642 rows to 624 rows
...
compare_diff <- compare %>% 
  ...
  dplyr::select(rgn_id, rgn_name, admin_country_name, year, value_v2022, value_v202, difference)
