...
# if you are connecting through cyberduck, the following string is what you enter for the server
url <- "ftp://ftp-access.aviso.altimetry.fr/climatology/global/delayed-time/monthly_mean/msla_h"
ub <- sprintf("ftp://%s@%s", userpasswd, substr(url, 7, 87)) # here, substr extracts the url string characters 7 thru 87, which is everything in the object url after "ftp://"
...
for (mo in months){ 
  ...
  u <- sprintf("%s/dt_global_allsat_msla_h_y2020_m%s.nc.gz", ub, mo)
  # within dir_anx_aviso, create new folder for this scenario year of data so the following line runs, name the folder d20??
  u_filename <- file.path(dir_anx_aviso, paste0("d", scen_year), substr(u, 115, 155)) #updated 2020 to include full filename
...
#nchar("ftp://userpasswd@ftp-access.aviso.altimetry.fr/climatology/global/delayed-time/monthly_mean/dt_global_allsat_msla_h_y2020_m01.nc.gz") # 131
...
# file.path: dir_M +
# git-annex/globalprep/_raw_data/AVISO_slr/d2022/ +
# _y2020_m01.nc.gz (for first month)
