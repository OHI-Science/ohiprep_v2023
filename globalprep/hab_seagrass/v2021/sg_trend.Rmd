...
This is basically recreating the analysis done in Short et al. 2011: https://www.researchgate.net/publication/235433892_Extinction_Risk_Assessment_of_the_World's_Seagrass_Species
 ...
 1. Use the IUCN maps to map the location of all species of seagrass (similar to the Short paper). Then: use Table 2 in Waycott to see whether species are increasing/decreasing. We gapfill the iucn population trend data with short data and vice versa when it is missing in the table. 
...
## Step 5
Calculate the trend using an species distribution area weighted mean. Create a gapfilling flag based on the proportion of species trends that are gapfilled within a region. 
