...
This script generates the health condition of kelp for each OHI region for the latest year of data. We do this by assigning a global average to those regions with decreasing trends. Any region with a stable or increasing trend receives a condition of 1. 
