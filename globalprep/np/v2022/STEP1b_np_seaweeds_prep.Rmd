...
source(here('globalprep/mar/v2022/mar_fxs.R')) # functions specific to mariculture dealing with compound countries
```
...
seaweeds <- read.csv(here("globalprep/np/v2022/raw/species_list_np_seaweeds.csv"), stringsAsFactors = FALSE)
