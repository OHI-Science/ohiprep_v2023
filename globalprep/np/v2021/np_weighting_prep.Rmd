...
## Saint Martin, Bonaie, Sint Eustasius are due to ornamental production going to completely 0 over the last 5 years. Last years weight was much higher, because there was still some ornamental production in 2013, but since there is an extra year of data, 2013 is excluded and now every year has a production/usd value of 0. These are all part of our Netherlands Antilles split.

## Niue; a similar thing happened to Niue, from 2014-2018 there is 0 production of ornamental now, which used to dominate (because its production of fofm is so small... but now that there is 0 ornamental and seaweed, the score is entirely driven by FOFM weights and production)

## Djibouti; changes for these weights are due to georegional gapfilling of ornamental tonnes data.
...
abline(0,1, col="red") ## these change because they are dependent upon the other things
