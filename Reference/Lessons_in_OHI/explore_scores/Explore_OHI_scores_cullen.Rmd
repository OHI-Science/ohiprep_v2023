...
The top regions with missing scores are Antarctica followed by several islands. Antarctica makes sense as it is not included in the assessment. Islands also make sense because they are likely small and could possibly be uninhabited. Many have no missing scores and they tend to be larger countries. I think the biggest reason is likely due to populatin size and resources, but I could see how some missing scores could also be from data availability.
