...
**If the trend in the previous five years was clearly nonlinear or non-monotonic. If we are aware of some recent change or event that will likely have a high impact on the score in the near future. If all five years of data were not available or reliable.**
...
```{r}
press_categories <- read.csv("https://raw.githubusercontent.com/OHI-Science/ohi-global/draft/eez/conf/pressure_categories.csv")
```
